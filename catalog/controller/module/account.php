...
class ControllerModuleAccount extends Controller {
	protected function index() {
		...
		/**
		 * add a new link for the customer inorder to add a new products 
		 * @name Mohammad Abuelezz <aboel3zz at maktoob dot com>
		 */
		$this->data['text_insert_product'] = $this->language->get('text_insert_product');		
		 ...
		 * @name Mohammad Abuelezz <aboel3zz at maktoob dot com>
		 */		
		$this->data['insert_product'] = $this->url->link('product/product/insert', '', 'SSL');		
