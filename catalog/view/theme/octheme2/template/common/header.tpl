...
<?php echo $title; ?>
<?php } else if ($lang == 'en'){ ?>
Arabian Land Company
<?php } else { ?>
Arap Arsa e-ticaret
<?php } ?>
</title>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/marquee.css" />
...
href="catalog/view/theme/octheme2/stylesheet/ar.css" />
<?php } else { ?>
<link rel="stylesheet" type="text/css"
href="catalog/view/theme/octheme2/stylesheet/stylesheet.css" />
<?php } ?>
...
<div id="callus"><img alt="" src="http://www.arabian-land.com/store/image/data/Call%20Us.gif"/></div>

<div id="xdate"><?php echo date('l jS F Y'); ?></div>
  
</div>
<div class="bmenu">
  <a class="homel" href="<?php echo $home; ?>"></a><div class="links"><a href="<?php echo $wishlist; ?>" id="wishlist_total"><?php echo $text_wishlist; ?></a><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a><a href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></div>
...
<div id="search">
    ...
    <?php } else { ?>
    <input type="text" name="filter_name" value="<?php echo $text_search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '#fff';" />
    <?php } ?>
  </div>
