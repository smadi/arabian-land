...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info-title"><?php echo $heading_title; ?></div>
  ...
  <?php if ($review_status) { ?>
      ...
      <div><img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<span><?php echo $reviews; ?></span></div>
    ...
    <div class="right">
      ...
      <div class="cart">
        <div><?php echo $text_qty; ?>
          ...
          &nbsp;<a id="button-cart" class="button5"><span><?php echo $button_cart; ?></span></a></div>
        <div><span>&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;</span></div>
  ...
  <div class="tab-title"><?php echo $tab_description; ?></div>
  <div id="tab-description" class="tab-content"><?php echo $description; ?></div>
  <?php if ($attribute_groups) { ?>
  <div class="tab-title"><?php echo $tab_attribute; ?></div>
  ...
  <?php } ?>
  <?php if ($review_status) { ?>
  <div class="tab-title"><?php echo $tab_review; ?></div>
  ...
  <?php } ?>
  <?php if ($products) { ?>
  <div class="tab-title"><?php echo $tab_related; ?> (<?php echo count($products); ?>)</div>
  <div id="tab-related" class="tab-content">
    <div class="box-product">
      ...
      <div>
        ...
        <?php } ?>
        <a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button5"><span><?php echo $button_cart; ?></span></a></div>
      <?php } ?>
    </div>
  </div>
  <?php } ?>
